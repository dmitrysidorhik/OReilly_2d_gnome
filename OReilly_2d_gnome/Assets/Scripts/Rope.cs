...
using UnityEngine;
//Веревка, состоявшая из звеньев
public class Rope : MonoBehaviour
{

    //Шаблон Rope Segment дял создания новых звеньев
    ...
    //Объект твёрдого тела, к которому следует присоеденить конец веревки
    public Rigidbody2D connectedObject;
    //Максимальная длинна звена веревки (если потребуется удлинить веревку больше, чем на эту величину, будет создано новое звено).
